...
var wss = {
    ...
    render: function (input, options, callback) {
        ...
        var parser = new(wss.Parser)(options),
            ee;
    ...
    writeError: function (ctx, options) {
        ...
        var error = [];
        var stylize = options.color ? wss.stylize : function (str) { return str };
...
wss.Parser.importer = function (file, paths, callback, env) {
    var pathname;
...
for (var k in wss) { exports[k] = wss[k] }
