...
if (typeof environment === "object" && ({}).toString.call(environment) === "[object Environment]") {
    ...
    // Browser
    if (typeof(window.wss) === 'undefined') { window.wss = {} }
    wss = window.wss,
    tree = window.wss.tree = {};
    wss.mode = 'browser';
}
//
// wss.js - parser
...
//
//
wss.Parser = function Parser(env) {
    var input,       // wss input string
    ...
    var imports = this.imports = {
        ...
        mime:  env && env.mime,         // MIME type of .wss files
        ...
        push: function (path, callback) {
            ...
            //
            wss.Parser.importer(path, this.paths, function (e, root, contents) {
    ...
    function $(tok) {
        ...
        // which come after that. The reason for this is that wss's
    ...
    // the lower the number, the wss nodes it will create in the tree.
    ...
    return parser = {
        ...
        parse: function (str, callback) {
            ...
            try {
                ...
                return callback(new(wssError)(e, env));
            }
            ...
            root.toCSS = (function (evaluate) {
                ...
                return function (options, variables) {
                    ...
                    try {
                        ...
                        throw new(wssError)(e, env);
                    }

                    if ((importError = parser.imports.error)) { // Check if there was an error during importing
                        if (importError instanceof wssError) throw importError;
                        else                                  throw new(wssError)(importError, env);
                    }

                    if (options.yuicompress && wss.mode === 'node') {
        ...
        parsers: {
            ...
            // but keep the wss comments `//` silent, by just skipping
            // over them.
            comment: function () {
                var comment;
...
if (wss.mode === 'browser' || wss.mode === 'rhino') {
    //
    // Used by `@import` directives
    //
    wss.Parser.importer = function (path, paths, callback, env) {
